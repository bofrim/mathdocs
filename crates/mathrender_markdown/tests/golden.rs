...
fn renders_feature_showcase_example() {
    let rendered = RenderEngine::default()
        ...
        .unwrap();
    assert!(rendered.markdown.contains("# MathRender Feature Showcase"));
...
fn applies_comment_auto_name_config() {
    let source = r#"
# mathrender: disable=auto_name/subscript
final_loss = 1
alpha = beta # mathrender: disable=auto_name/symbol
"#;
...
#[test]
fn applies_root_mathrender_toml_auto_name_config() {
